...
<body>
	...
	<form action="https://<%= AdAndLifeWebsite.Classes.Utility.USE_TEST_PAYPAL ? "www.sandbox.paypal.com" : "www.paypal.com" %>/cgi-bin/webscr" id="frm" method="post"> 
		<input type="hidden" name="cmd" value="_cart" />
		<input type="hidden" name="upload" value="1" />
		<input type="hidden" name="business" value="<%= AdAndLifeWebsite.Classes.Utility.USE_TEST_PAYPAL ? "R28N4TKRNCR4E" : "R6FMTNX6C9BB8" %>" />   
