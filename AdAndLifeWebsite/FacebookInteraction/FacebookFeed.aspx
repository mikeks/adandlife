...
<script runat="server">
    ...
    Private Shared Function ExtractPar(ByVal s As String, ByVal paramName As String) As String
    ...
    Private Function getAccessToken(ByVal code As String) As String
        ...
        Try
            ...
            Dim token = ExtractPar(response, "access_token")
            Return token
    ...
    Protected Sub Load_Page(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If code IsNot Nothing Then
                ...
                o.Add("message", "test message")
                o.Add("link", feed.Link)
            ...
            Else
                ...
                Dim redirectURL = "https://www.facebook.com/dialog/oauth?client_id=" & AppId & "&redirect_uri=" & callBackURL & "&scope=publish_actions,manage_pages"
